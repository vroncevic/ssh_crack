...
"""
 ...
 Copyright
     ...
     ssh_crack is free software: you can redistribute it and/or
     modify it under the terms of the GNU General Public License as published
     by the Free Software Foundation, either version 3 of the License, or
     (at your option) any later version.
     ssh_crack is distributed in the hope that it will be useful,
 ...
 Info
     Define setup for tool ssh_crack.
"""
...
setup(
    name='ssh_crack',
    version='1.0.0',
    description='SSH cracking',
    author='Vladimir Roncevic',
    author_email='elektron.ronca@gmail.com',
    url='https://vroncevic.github.io/ssh_crack',
    license='GPL 2020 Free software to use and distributed it.',
    long_description=LONG_DESCRIPTION,
    long_description_content_type='text/markdown',
    keywords='Unix, Linux, Development, SSH',
    platforms='POSIX',
    ...
    data_files=[(
        '/usr/local/bin/', [
            '{0}{1}'.format(TOOL_DIR, 'run/ssh_crack_run.py')
        ]
    )]
)
